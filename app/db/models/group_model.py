...
class GroupModel(BaseModel):
    ...
    groups_members: Mapped[List["GroupMemberModel"]] = relationship(back_populates="group")
...
class GroupMemberModel(BaseModel):
    ...
    group: Mapped["GroupModel"] = relationship(back_populates="groups_members")
    user: Mapped["UserModel"] = relationship(back_populates="groups_members")
